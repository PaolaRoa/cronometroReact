...
const Buttons = (props)=> {
    ...
    return(
        ...
        {/* renderizamos un boton de stop y uno de vuelta, las funciones de los botones viene ¿n como props*/}
            {props.isStop === "running" ? <div className="buttonsContainer"><button className = "stop" onClick = {props.handleStatus}><img className= "buttonIcon"alt= "Stop" src= "https://cdn.pixabay.com/photo/2014/04/03/00/40/button-309039_960_720.png"></img></button>
